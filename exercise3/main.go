...
func main() {
	...
	var (
		//Ingresar la cantidad de minutus trabajados.
...
func calcularSalario(minMensuales float64, categoria string) (float64, error) {
	...
	if minMensuales <= 0 {
		return 0, errors.New("Debes agregar la cantidad de minutos trabajados")
	}

	if categoria == "" {
		return 0, errors.New("Debes agregar una categoria en la que se encuentra el empleado")
	}
